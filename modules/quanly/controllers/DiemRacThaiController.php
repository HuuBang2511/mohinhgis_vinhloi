...
use app\modules\quanly\models\DiemRacThaiSearch;
...
/**
 * DiemRacThaiController implements the CRUD actions for DiemRacThai model.
 */
class DiemRacThaiController extends \app\modules\quanly\base\QuanlyBaseController
{

    public $title = "Điểm rác thải";

    /**
     * Lists all DiemRacThai models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new DiemRacThaiSearch();
    ...
    /**
     * Displays a single DiemRacThai model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new DiemRacThai model.
        ...
        if($model->load($request->post()) && $model->save() && $filedinhkem->load($request->post())){
            ...
            if($filedinhkem->fileupload != null){
                ...
                foreach($filedinhkem->fileupload as $i => $item){
                    ...
                    $file[] = 'uploads/diem-rac-thai/'.$model->id.'/'.$item->baseName.'.'.$item->extension;
                    $path = 'uploads/diem-rac-thai/'.$model->id.'/';
    ...
    /**
     * Updates an existing DiemRacThai model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing DiemRacThai model.
     * For ajax request will return json object
    ...
    /**
     * Finds the DiemRacThai model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return DiemRacThai the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = DiemRacThai::findOne($id)) !== null) {
            return $model;
        } else {
