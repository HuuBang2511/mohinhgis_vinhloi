...
use app\modules\quanly\models\TramThoatNuocSearch;
...
/**
 * TramThoatNuocController implements the CRUD actions for TramThoatNuoc model.
 */
class TramThoatNuocController extends \app\modules\quanly\base\QuanlyBaseController
{

    public $title = "Trạm thoát nước";

    /**
     * Lists all TramThoatNuoc models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new TramThoatNuocSearch();
    ...
    /**
     * Displays a single TramThoatNuoc model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new TramThoatNuoc model.
        ...
        if($model->load($request->post()) && $model->save() && $filedinhkem->load($request->post())){
            ...
            if($filedinhkem->fileupload != null){
                ...
                foreach($filedinhkem->fileupload as $i => $item){
                    ...
                    $file[] = 'uploads/tram-thoat-nuoc/'.$model->id.'/'.$item->baseName.'.'.$item->extension;
                    $path = 'uploads/tram-thoat-nuoc/'.$model->id.'/';
    ...
    /**
     * Updates an existing TramThoatNuoc model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing TramThoatNuoc model.
     * For ajax request will return json object
    ...
    /**
     * Finds the TramThoatNuoc model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return TramThoatNuoc the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = TramThoatNuoc::findOne($id)) !== null) {
            return $model;
        } else {
