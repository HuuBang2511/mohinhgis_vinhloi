...
use app\modules\quanly\models\ChieuSangSearch;
...
/**
 * ChieuSangController implements the CRUD actions for ChieuSang model.
 */
class ChieuSangController extends \app\modules\quanly\base\QuanlyBaseController
{

    public $title = "Điểm chiếu sáng";

    /**
     * Lists all ChieuSang models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new ChieuSangSearch();
    ...
    /**
     * Displays a single ChieuSang model.
     * @param integer $id
     * @return mixed
     */
        ...
        if($model->load($request->post()) && $model->save() && $filedinhkem->load($request->post())){
            ...
            if($filedinhkem->fileupload != null){
                ...
                foreach($filedinhkem->fileupload as $i => $item){
                    ...
                    $file[] = 'uploads/chieu-sang/'.$model->id.'/'.$item->baseName.'.'.$item->extension;
                    $path = 'uploads/chieu-sang/'.$model->id.'/';
    ...
    /**
     * Updates an existing ChieuSang model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing ChieuSang model.
     * For ajax request will return json object
    ...
    /**
     * Finds the ChieuSang model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return ChieuSang the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = ChieuSang::findOne($id)) !== null) {
            return $model;
        } else {
