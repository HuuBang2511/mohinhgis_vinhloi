...
class DiemRacThai extends QuanlyBaseModel
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'ma_diem'              => 'Mã Điểm',
            'ten_diem'             => 'Tên Điểm',
            'loai_hinh'            => 'Loại Hình (Điểm tập kết / Trạm trung chuyển / Bãi chứa tạm / Thùng rác công cộng)',
            'suc_chua_m3'          => 'Sức Chứa (m³)',
            'dien_tich_m2'         => 'Diện Tích (m²)',
            'loai_rac_tiep_nhan'   => 'Loại Rác Tiếp Nhận (Rác sinh hoạt / Rác cồng kềnh / Rác tái chế / Rác nguy hại / Tất cả)',
            'so_thung_rac'         => 'Số Thùng Rác',
            'the_tich_thung_l'     => 'Thể Tích Thùng (Lít)',
            'tinh_trang'           => 'Tình Trạng (Hoạt động / Quá tải / Tạm đóng / Ô nhiễm nặng)',
            ...
            'hay_bi_qua_tai'       => 'Thường Xuyên Quá Tải',
            'khoang_cach_dan_cu_m' => 'Khoảng Cách Dân Cư (m)',
            'phan_anh_mui'         => 'Phản Ánh Về Mùi',
            'phuong_xa'            => 'Phường/Xã',
