...
document.addEventListener('DOMContentLoaded', function () {
    const App = {
        // --- CONFIGURATION ---
        WMS_URL: 'https://nongdanviet.net/geoserver/mohinhgis_vinhloi/wms',
        GEOJSON_VUVEC_URL: 'https://nongdanviet.net/geoserver/mohinhgis_vinhloi/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=mohinhgis_pa05%3Avu_viec&maxFeatures=5000&outputFormat=application%2Fjson',
        DETAIL_URLS: {
